# -*- coding: utf-8 -*-
"""Beale-Chapman-HW4-PHYS486.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NE5mo7F4xsTmYGyzgZHAei0xgWl532WV
...
'''
Authors: Val and Nate
Title: Fringing field of a parallel plate capacitor
Goal: Numerically solve Laplace's equation on a grid around a paralle plate capacitor, and investigate how the magnitude of the electric field changes with distance from the capacitor and plate seperation
'''
